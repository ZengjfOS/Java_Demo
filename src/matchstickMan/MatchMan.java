...
//		System.out.println();
	...
	private void getAngle() {
		...
		stringBuilder.append(string+"};\n\tNO.1号左脚X,Y坐标: int[] leftFoot"+counter+" = {");
		...
		stringBuilder.append(string+"};\n\tNO.2号左脚X,Y坐标: int[] leftFoot"+counter+" = {");
		...
		stringBuilder.append(string+"};\n\t左脚相对坐标(X,Y): int[] relative = {"+(secondFootX-firstFootX)+", "+(secondFootY-firstFootY)+"};\n\n");
		showDateTextArea.append(stringBuilder.toString());	
		counter++;
	}
	/**
	...
	private void addLabelAndTextField(JPanel jPanel) {
		JLabel leftFootLabel = new JLabel("左脚:", JLabel.CENTER);
		JLabel leftCrusLabel = new JLabel("左小腿:", JLabel.CENTER);
		JLabel leftThighLabel = new JLabel("左大腿:", JLabel.CENTER);
		JLabel trunkLabel = new JLabel("躯干:", JLabel.CENTER);
		JLabel rightThighLabel = new JLabel("右大腿:", JLabel.CENTER);
		JLabel rightCrusLabel = new JLabel("右小腿:", JLabel.CENTER);
		JLabel rightFootLabel = new JLabel("右脚:", JLabel.CENTER);
		JLabel leftArmLabel = new JLabel("左胳膊:", JLabel.CENTER);
		JLabel leftForearmLabel = new JLabel("左前臂:", JLabel.CENTER);
		JLabel rightArmLabel = new JLabel("右胳膊:", JLabel.CENTER);
		JLabel rightForearmLabel = new JLabel("右前臂:", JLabel.CENTER);
		JLabel nullLabel = new JLabel("(x,y)", JLabel.CENTER);
		JLabel headLabel1 = new JLabel("1号头:", JLabel.CENTER);
		JLabel headLabel2 = new JLabel("2号头:", JLabel.CENTER);
		JLabel leftFoot1 = new JLabel("1号左脚:", JLabel.CENTER);
		JLabel leftFoot2 = new JLabel("2号左脚:", JLabel.CENTER);
